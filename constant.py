...
from model import main_RSCNet, main_EfficientFi, main_CSINet, main_LASSO, main_DeepCMC, main_CloudSense
    ...
    "baseline": {
        ...
        "Ours": {
            ...
            "config": {
                ...
                "unrilable_rate_in_training": 0.01
            }
        }
    }
}
